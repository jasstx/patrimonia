...
class PatrimoinesTableSeeder extends Seeder
{
    public function run()
    {
        ...
        // 1. Catégorie CPNU
        // ===============================
        $cpnu = Categorie::where('code', 'CPNU')->first();
        $elementsCPNU = [
        ...
        // 2. Catégorie PSREF
        // ===============================
        $psref = Categorie::where('code', 'PSREF')->first();
        $elementsPSREF = [
        ...
        // 3. Catégorie ADS
        // ===============================
        $ads = Categorie::where('code', 'ADS')->first();
        $elementsADS = [
        ...
        // 4. Catégorie SFAT
        // ===============================
        $sfat = Categorie::where('code', 'SFAT')->first();
        $elementsSFAT = [
        ...
        // 5. Catégorie TEO
        // ===============================
        $teo = Categorie::where('code', 'TEO')->first();
        $elementsTEO = [

...
class Demande extends Model
{
    ...
    public function valider(User $validateur, $motif = null)
    {
        $this->update([
    ...
    public function rejeter(User $rejeteur, $motif)
    {
        $this->update([
    ...
    private function creerDetenteur()
    {
        ...
        if ($demandeur && !$demandeur->detenteur) {
            Detenteur::create([
                'type_detenteur' => $demandeur->type_detenteur,
